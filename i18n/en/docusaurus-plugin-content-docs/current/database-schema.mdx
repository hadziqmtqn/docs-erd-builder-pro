...
<details>
<summary>Supabase SQL Schema (DDL + RLS Policies + Triggers + Seed)</summary>
...
<details>
<summary>Pure PostgreSQL SQL Schema (DDL + Foreign Keys + Indexes)</summary>
...
| `db_accounts` | `public` | Integration | External database connection credentials (desktop-only) |
| `db_catalogs` | `public` | Integration | Specific database within a db_account |
