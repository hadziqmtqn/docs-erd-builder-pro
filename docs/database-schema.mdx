...
import FullscreenERD from '@site/src/components/ERDEmbed/FullscreenERD';
...
<FullscreenERD height="600px" nodes={supabaseNodes} edges={supabaseEdges} />

  </TabItem>
  <TabItem value="purepg" label="Pure PostgreSQL">

<FullscreenERD height="600px" nodes={purePgNodes} edges={purePgEdges} />
